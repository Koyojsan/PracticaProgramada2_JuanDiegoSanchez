...
namespace PracticaProgramada2_JuanDiegoSanchez.Controllers
{
    public class TareasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdTarea,IdLista,Nombre,Descripcion,Fecha,Pendiente")] Tarea tarea)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTarea,IdLista,Nombre,Descripcion,Fecha,Pendiente")] Tarea tarea)
        {
            if (id != tarea.IdTarea)
            {
                return NotFound();
